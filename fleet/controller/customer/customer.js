...
exports.getAllCustomers = async(req, res) => {
    try {
        ...
        if (!customers || customers.length === 0) {
            return res.render('fleet/components/customer/customer', { customers: [], error: 'No customers available.' });
        }
        ...
        res.render('fleet/components/customer/customer', { customers: [], error: 'Error fetching customers.' });
    }
};
...
//         res.redirect('/fleet/manage-customer'); // Redirect to the list of customers after deletion
...
//         //     }
//         // });
//         res.redirect('/fleet/manage-customer');
//     } catch (error) {
